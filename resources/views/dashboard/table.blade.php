                                    ...
                                    <form action="{{ route('admin.cars')}}" method="GET" class="form-header pb-5" enctype="multipart/form-data">
                                        ...
                                        <div class="rs-select2--light rs-select2--md mr-4">
                                            <select class="js-select2" name="search_name_cars">
                                                <option selected="selected" disabled>nome des voitures</option>
                                    ...
                                    <div class="table-data__tool-right">
                                        ...
                                        <div class="rs-select2--dark rs-select2--sm rs-select2--dark2">
                                            <select class="js-select2" name="type">
                                                <option selected="selected" disabled>Exportation</option>
                                            ...
                                            <tr class="tr-shadow">
                                                ...
                                                <td>
                                                    <div class="table-data-feature">
                                                        ...
                                                        <form action="{{route('admin.softDelete',$item->id)}}"  method="POST">
                                                            @csrf
                                                            @method('PUT')
