                            ...
                            <div class="header-button">
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="{{url('dataimg/adminimg/')}}/{{Auth::user()->img}}" alt="John Doe" />
                                        </div>
                                        <div class="content">
                        ...
                        <div class="section__content section__content--p30">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="copyright">
                                            <p>Copyright © 2022 . Tous les droits sont réservés. Modèle par <a href="http://wwww.zahirdaoui.com" target="_blank"> EZZAHIR DAOUI</a>.</p>
                                </div>
                            </div>
                        </div>
                    </div>
